    ...
    <div className="flex sm:flex-row flex-col justify-center sm:gap-4 items-center">
      ...
      <div className="sm:h-screen flex flex-col justify-center items-center sm:mt-0 mt-4">
        <div className="flex gap-3 relative">
          <div>
            <div className="rounded-[12px] bg-green-600 rounded-[14px] w-54 sm:w-60 h-50 flex flex-col justify-between p-4">
          ...
          <div className="relative flex sm:flex-row gap-4 sm:gap-0 flex-col justify-start sm:justify-end">
            <div className="shadow-md sm:shadow-gray-600 top-20 -right-20 w-40 h-21 sm:h-24 bg-red-500 rounded-[14px] block sm:absolute flex flex-col justify-center items-center ">
              <h3 className="text-white">Current Members</h3>
              <h3 className="text-white text-3xl sm:text-5xl font-bold">230</h3>
            </div>
            <div className="bottom-2 sm:shadow-md shadow-gray-600  -right-20 w-40 h-21 sm:h-24 bg-blue-500 rounded-[14px] block sm:absolute flex flex-col justify-center items-center">
              <h3 className="text-white">Events & Workshops</h3>
              <h3 className="text-white text-3xl sm:text-5xl font-bold">23</h3>
            </div>
            <div className="-top-1 sm:shadow-md shadow-gray-600 -right-20 w-40 h-22 sm:h-21 bg-green-500 rounded-[14px] block flex flex-col justify-center items-center block sm:hidden">
        ...
        <div className="mt-2 relative">
          ...
          <Image
            className="flex flex-col justify-center rounded-[14px] bg-red-500 h-47"
            src="https://www.shutterstock.com/image-photo/portrait-cheerful-male-international-indian-600nw-2071252046.jpg"
            alt="nothing"
            width={528}
            height={176}
